 ...
 <div class="name">
    ...
    <div class="container-fluid"> 
        ...
        <form action="${contextPath}/admin/insertBannerImg" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
            <div id="upload">
                <div  id="pic" style="text-align: center; margin-top: 10px; ">
                <div id="imagePreviewContainer2"
                        ...
                        <div style="margin-top: 50px;"><i class="bi bi-file-plus"></i></div>
               </div>
                        <div>
                           <input type="file" name="image_url" multiple style="margin-bottom: 6px;"
            ...
            <div id="sub" class="sub">
                	...
                	<input type="submit" class="btn btn-primary btn-sm pull-right" style="background-color: #537FE7;"  value="등록하기" />
            </div> 
             </form>
