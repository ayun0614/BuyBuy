					...
					<div class="col-md-1 header-item">
						...
						<c:if test="${!empty mvo}">
							...
							<div class="header-profile">
								<a href="${contextPath}/account/membermodify?member_id=${mvo.member_id}"
								...
								<c:if test="${empty mvo.profileimg}">
									<!-- 프로필 이미지가 없는 경우 -->
									<img src="${contextPath}/resources/image/kakaotalkimg.jpg"
										style="width: 50px; height: 50px; border-radius: 50%;" />
								</c:if>
								<c:if test="${!empty mvo.profileimg}">
									<!-- 프로필 이미지가 있는 경우 -->
									<img src="${contextPath}/resources/upload/${mvo.profileimg}"
										style="width: 50px; height: 50px; border-radius: 50%;" />
								</c:if>
							</div>
						</c:if>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="header-hover header-menu header-second">
						<img class="header-icon" style="margin-right: -3px; margin-top: -5px;" alt=""
