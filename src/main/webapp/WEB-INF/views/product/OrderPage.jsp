		...
		<hr class=" hrSec">
							...
							<div class="userInfoBox">
								<table class="userInfoTbl">
									<tr class="userInfoTr">
										...
										<td class="userInfoTd"><span id="userInfoNameSpan">${mvo.memName }</span> <input
												type="text" class="form-control" id="userInfoNameInput"
												value=${mvo.memName }></td>
										<td align="right">
											<button type="button" class="btn btn-default"
												id="userInfoUpdateBeBtn">수정</button>
											<button type="button" class="btn btn-default"
												id="userInfoUpdateAfBtn">완료</button>
										</td>
									</tr>
									<tr class="userInfoTr">
										<td class="userInfoTd">전화번호</td>
										<td class="userInfoTd"><span id="userInfoTelSpan">${mvo.memEmail }</span> <input
												type="text" class="form-control" id="userInfoTelInput"
							...
							<div class="userInfoBox">
								<table class="userInfoTbl" style="width: 800px;">
									<tr class="userInfoTr">
										...
										<td style="width: 105px;" class="userInfoTd"><span
												id="buyerInfoNameSpan">${mvo.memName }</span> <input type="text"
												class="form-control" id="buyerInfoNameInput" value=${mvo.memName }></td>
										<td align="right">
											<button type="button" class="btn btn-default"
												id="buyerInfoUpdateBeBtn">수정</button>
											<button type="button" class="btn btn-default"
												id="buyerInfoUpdateAfBtn">완료</button>
										</td>
									</tr>
									<tr class="userInfoTr">
										<td style="width: 105px;">전화번호</td>
										<td class="userInfoTd"><span id="buyerInfoTelSpan">${mvo.memEmail }</span>
											<input type="text" class="form-control" id="buyerInfoTelInput"
												value=${mvo.memEmail }></td>
									</tr>
									<tr class="userInfoTr">
										<td style="width: 105px;">주소</td>
										<td class="userInfoTd" style="width: 500px;"><span id="buyerInfoAdrSpan">서울특별시
												서초구</span>
											<div class="buyerInfoAdrInputDiv">
												...
												<div class="buyerInfoAdrInputGroup">
													<input type="text" id="sample6_postcode" class="form-control"
														placeholder="우편번호">
													<button onclick="sample6_execDaumPostcode()" class="btn">우편번호
														찾기</button>
												</div>
									...
									<tr class="userInfoTr">
										<td class="userInfoTd" colspan="3"><label for="memo" class="delMemoLabel">
							...
							<div class="userInfoBox">
								<div class="paymentRadioGroup">
									<label style="font-size: 18px;" class="paymentRadio"><input type="radio"
											name="optradio" class="paymentDivHide" id="cardpay" value="cardpay">&nbsp카드
										결제</label> <label style="font-size: 18px;" class="paymentRadio"><input
											type="radio" name="optradio" class="paymentDivHide" id="passBookpay"
											value="passBookpay">&nbsp무통장 입금</label> <label style="font-size: 18px;"
										class="paymentRadio"><input type="radio" name="optradio" class="paymentDivHide"
											id="tosspay" value="tosspay">&nbsp토스페이</label> <label
										style="font-size: 18px;" class="paymentRadio"><input type="radio"
											name="optradio" class="paymentDivShow" id="giftCardpay"
											value="giftCardpay">&nbsp문화상품권</label>
								</div>
							</div>
							<div class="buyCheckbox">
								<label style="font-size: 16px;"><input type="checkbox" id="buyCheckBox">구매 정보 저장 및 결제
									진행에 동의</label>
							...
							<table class="userInfoTbl" style="width:800px;">
								<tr class="userInfoTr">
									...
									<td style="width: 105px;" class="userInfoTd">
										...
										<input type="text" class="form-control" id="buyerInfoNameInput"
											value="${mvo.name }">
									</td>
									<td align="right">
										<button type="button" class="btn btn-default"
								...
								<tr class="userInfoTr">
									...
									<td class="userInfoTd" style="width: 500px;">
										<span id="buyerInfoAdrSpan">${mvo.zipcode } &nbsp ${mvo.addr } &nbsp
											${mvo.detailaddr }</span>
										<div class="buyerInfoAdrInputDiv">
											<br>
											<div class="buyerInfoAdrInputGroup"><input type="text" id="sample6_postcode"
													class="form-control" placeholder="우편번호" value="${mvo.zipcode }">
												<button onclick="sample6_execDaumPostcode()" class="btn">우편번호
													찾기</button>
											</div>
											<input type="text" id="sample6_address" class="form-control"
												placeholder="주소" value="${mvo.addr }">
											<input type="text" id="sample6_detailAddress" class="form-control"
												placeholder="상세주소" value="${mvo.detailaddr }">
											<input type="text" id="sample6_extraAddress" class="form-control"
												placeholder="참고항목">
										</div>
									</td>
							...
							<table class="userInfoTbl" style="width:800px;">
								<tr class="userInfoTr">
									...
									<td style="text-align:right">
										<fmt:formatNumber value="${moo.original_price }" pattern="#,##0" />원
									</td>
								</tr>
								<tr class="userInfoTr">
									<td>할인</td>
									<td style="text-align:right">-
										<fmt:formatNumber value="${moo.original_price-moo.discount_price }"
											pattern="#,##0" />원
									</td>
								</tr>
								<tr class="userInfoTr">
								...
								<tr class="userInfoTr">
									<td class="lastPayTextTd">총 결제 금액</td>
									<td class="lastPayTd">
										<fmt:formatNumber value="${moo.discount_price+2500}" pattern="#,##0" />원
									</td>
								</tr>
							</table>
						</div>
						...
						<div class="userInfoBox">
							<div class="paymentRadioGroup">
								<label style="font-size:18px;" class="paymentRadio"><input type="radio" name="optradio"
										class="paymentDivHide" id="cardpay" value="카드 결제">&nbsp카드 결제</label>
								<label style="font-size:18px;" class="paymentRadio"><input type="radio" name="optradio"
										class="paymentDivHide" id="passBookpay" value="무통장 입금">&nbsp무통장 입금</label>
								<label style="font-size:18px;" class="paymentRadio"><input type="radio" name="optradio"
										class="paymentDivHide" id="tosspay" value="토스페이">&nbsp토스페이</label>
								<label style="font-size:18px;" class="paymentRadio"><input type="radio" name="optradio"
										class="paymentDivShow" id="giftCardpay" value="문화상품권">&nbsp문화상품권</label>
							</div>
						</div>

						<div class="buyCheckbox">
							<label style="font-size:16px;"><input type="checkbox" id="buyCheckBox">구매 정보 저장 및 결제 진행에
								동의</label>
							<button type="button" class="btn" id="buyBtn" onclick="requestPay()">상품 결제</button>
						</div>
					</div>
