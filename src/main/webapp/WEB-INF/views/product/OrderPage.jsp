...
<div class = "bodyDiv">
  <jsp:include page="../always/header.jsp"/> 
   ...
   <div class = "productInfoBox">
      ...
      <img src="resources/upload/${mvo.memProfile}" class = "myInfoImg""/>
      </div>
   ...
   <div class = "userInfoBox">
      <table class = "userInfoTbl">  
         <tr class = "userInfoTr"> 
            ...
            <td class = "userInfoTd">
               <span id = "userInfoNameSpan">${mvo.memName }</span>
               <input type="text" class="form-control" id = "userInfoNameInput" value = ${mvo.memName }>
            </td>
            <td align = "right">
         ...
         <tr class = "userInfoTr"> 
            ...
            <td class = "userInfoTd">
               <span id = "userInfoTelSpan">${mvo.memEmail }</span>
               <input type="text" class="form-control" id = "userInfoTelInput" value = ${mvo.memEmail }>
            </td>
         </tr>
      </table>
   </div>
   ...
   <div class = "userInfoBox">
      <table class = "userInfoTbl" style = "width:800px;">
         <tr class = "userInfoTr">
            ...
            <span id = "buyerInfoNameSpan">${mvo.memName }</span>
            <input type="text" class="form-control" id = "buyerInfoNameInput" value = ${mvo.memName }>
            </td>
            <td align = "right">
         ...
         <tr class = "userInfoTr"> 
            ...
            <td class = "userInfoTd">
            <span id = "buyerInfoTelSpan">${mvo.memEmail }</span>
            <input type="text" class="form-control" id = "buyerInfoTelInput" value = ${mvo.memEmail }>
            </td>
         </tr>
         <tr class = "userInfoTr"> 
            <td style = "width: 105px;">주소</td>
            <td class = "userInfoTd" style = "width: 500px;">
               <span id = "buyerInfoAdrSpan">서울특별시 서초구</span>
               <div class = "buyerInfoAdrInputDiv">
                  <br>
                  <div class = "buyerInfoAdrInputGroup"><input type="text" id="sample6_postcode" class="form-control" placeholder="우편번호">
