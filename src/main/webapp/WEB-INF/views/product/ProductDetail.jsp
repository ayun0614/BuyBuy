...
function ProductTimeout() {
	...
	window.location.href = "${contextPath}/ProductTimeout?product_idx=${productDetail.product_idx}";
...
<body>
	...
	<div class="container" style="max-width: 900px; height: 100px;">
		...
		<br>
		<form action="${contextPath}/OrderPage" method="get"
			...
			<input type="hidden" id="product_idx" name="product_idx"
				...
				href="${contextPath}/ProductList" style="font-size: 20px;"> <span
			...
			<div class="row middle" style="height: 400px; text-align: center;">
				<div class="row"
					...
					<div class="col-md-6"
						style="border-radius: 30px; width: 450px; height: 435px; overflow: hidden; border: 1px solid black; margin-left: 6px; margin-top: 6px; margin-bottom: 6px;">
						<img
						...
						<div>
							<div class="input-group">
								<span class="input-group-addon" id="basic-addon1">판매자</span> <input
									type="text" value="${productDetail.member_id}" readonly
							...
							<div class="row">
								...
								<div class="col-md-5" style="margin-top: 10px; display: flex;">
									<c:if test="${!empty mvo}">
										...
										<c:if
											test="${productDetail.member_id eq mvo.member_id}">
											<!-- 여기에 해당 멤버에게 보여줘야 하는 내용 추가 -->
											<a
												href="${contextPath}/ProductModify?product_idx=${productDetail.product_idx}"
