...
<body>
    ...
    <img id="productThumbnail" src="${contextPath}/resources/upload/${productDetail.thumbnail_img}" alt="thumbnail_img" style="width: 100%; height: 100%; object-fit: contain;">
</div>
					<div class="col-md-6">
						<br>
						<div>
							...
							<tr>
								<td rowspan="2"
									...
									<div
										...
										<img
											src="https://th.bing.com/th/id/OIP.t31yu1KhzSofEN6wHWN3BgHaHa?w=187&h=187&c=7&r=0&o=5&pid=1.7"
											alt="프로필 이미지"
