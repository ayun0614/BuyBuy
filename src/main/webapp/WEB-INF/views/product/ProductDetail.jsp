...
<script
  ...
  <script>
        $(document).ready(function () {
            ...
            // Disable "주문하기" button for dealers and admins
            var accountState = "${mvo.account_type}";

            if (accountState === "dealer" || accountState === "admin") {
...
$(document).ready(function () {
    ...
    function calculateDiscount() {
        ...
        if (!isNaN(regularPrice) && !isNaN(salePrice)) {
            ...
            document.getElementById('discountPriceDisplay').textContent = '총금액: ' + discountedPrice.toFixed(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',') + '원';
        } else {
    ...
    function productBuy() {
        var confirmOrder = confirm("해당 상품을 주문하시겠습니까?");
      ...
      <br>
       <form action="productBuy" method="get" onsubmit="return validateForm()" enctype="multipart/form-data">
         ...
         <div class="row middle" style="height: 400px; text-align: center;">
            <div class="row"
               style="height: 450px;">
            <div class="col-md-6" style="width: 450px; height: 435px; overflow: hidden; margin-left: 6px; margin-top: 6px; margin-bottom: 6px;">
