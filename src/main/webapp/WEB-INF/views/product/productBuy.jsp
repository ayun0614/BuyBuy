	...
	<div class="bodyDiv">
		...
		<div class="userInfoBox">
			<table class="userInfoTbl">
				<tr class="userInfoTr">
					...
					<td class="userInfoTd"><span id="userInfoNameSpan">${mo.name }</span></td>
				</tr>
				<tr class="userInfoTr">
					<td style="width: 16px;" class="userInfoTd">전화번호</td>
					<td class="userInfoTd"><span id="userInfoTelSpan">${mo.phone }</span></td>
				</tr>
			</table>
		</div>
		<hr class="hrSec">
		...
		<div class="userInfoBox">
			<table class="userInfoTbl" style="width: 800px;">
				<tr class="userInfoTr">
					...
					<td style="width: 105px;" class="userInfoTd"><span id="buyerInfoNameSpan">${mo.name }</span> <input type="text" class="form-control" id="buyerInfoNameInput" value=""></td>
					<td align="right">
				...
				<tr class="userInfoTr">
					...
					<td class="userInfoTd"><span id="buyerInfoTelSpan">${mo.phone }</span> <input type="text" class="form-control" id="buyerInfoTelInput" value=""></td>
				</tr>
				<tr class="userInfoTr">
					<td style="width: 105px;">주소</td>
					<td class="userInfoTd" style="width: 500px;"><span id="buyerInfoAdrSpan">${mo.zipcode } &nbsp ${mo.addr } &nbsp ${mo.detailaddr }</span>
						<div class="buyerInfoAdrInputDiv">
							<br>
							<div class="buyerInfoAdrInputGroup">
								<input type="text" id="sample6_postcode" class="form-control" placeholder="우편번호" value="">
		...
		<div class="userInfoBox">
			<table class="userInfoTbl" style="width: 800px;">
				...
				<tr class="userInfoTr">
					<td>할인</td>
					<td style="text-align: right">- <fmt:formatNumber value="${moo.original_price-moo.discount_price }" pattern="#,##0" />원
					</td>
				</tr>
				<tr class="userInfoTr">
					<td>배송비</td>
