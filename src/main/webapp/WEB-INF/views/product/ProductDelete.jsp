					...
					<div class="row" style="max-width: 890px; height: 100px;">
						<div class="row top text-dark">
							<input type="text" name="product_Name" readonly id="product_Name"
								value="${productDetail.product_name }" class="form-control" placeholder="제품 이름">
						</div>
					</div>
            ...
            enctype="multipart/form-data">-->
								...
								<table class="table table-bordered"
									...
									<div class="col-sm-6 col-md-4" style="width: 440px; ">
										<div class="card-ui">
											<div class="thumbnail">
												<img src="${contextPath}/resources/upload/${productDetail.thumbnail_img}"
													alt="thumbnail_img">
											</div>
										</div>
									</div>
						...
						<div class="col-md-6 middle-right text-dark">
							...
							<div class="row middle-right-1">
								...
								<div class="col-md-6">
									<td style="vertical-align: middle;">등록상태</td> <br> <select id="cars" name="cars"
								...
								<div class="col-md-6">
									...
									<input type="text" name="original_price" id="original_price" readonly
										value="${productDetail.original_price }" onchange="calculateDiscount()" />
								</div>
								<div class="col-md-6">
							...
							<div class="row middle-right-3 text-dark">
								...
								<div class="num">
									<span>수량</span> <span class="count"> <a href="#" class="minus">-</a> <span
											id="result">1</span> <a href="#" class="plus">+</a>
									</span>
					...
					<div class="row bottom text-dark">
						...
						enctype="multipart/form-data">-->
										...
										<table class="table table-bordered"
											...
											<div class="thumbnail">
												<img src="${contextPath}/resources/upload/${productDetail.detail_img}"
													alt="detail_img">
											</div>
										</table>
										<!--</form>-->
