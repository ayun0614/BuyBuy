                  ...
                  <div class="panel panel-default">
                     ...
                     <div class="tab-content">
                        ...
                        style="height: 300px; width: 300px; text-align: center; margin: 0 auto;">
                              <address>
                                 <strong>판매자 이름</strong><br> ${mvo.name }<br>
                              </address>
                                 <address>
                                 <strong>전화번호</strong><br>${mvo.phone }</a>
                              </address>
                              <address>
                                 <strong>이메일</strong><br> <a href="mailto:#">${mvo.email }</a>
                              </address>
                              
                              <address>
                                 <strong>사업장 주소</strong><br>${mvo.addr }</a>
                              </address>
                              <address>
                                 <strong>상세주소</strong><br>${mvo.detailaddr }</a>
                              </address>
                     </div>
                        </div>
                     </div>
