...
<div class = "bodyDiv">
  <div class = "myPageSubDiv"><a href = "myPageOrder"><img src = "resources/image/Back.png" class = "backBtn"></a>
...
<hr>
	...
	<div style = "margin-top:20px; margin-left:100px;"><label style = "font-size:18px;">${mo.pay_type}</label></div>
		<br><br><br><br><br>
</div>
</body>
</html>