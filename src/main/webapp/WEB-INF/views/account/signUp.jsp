...
$(document).ready(function() {
   ...
   function checkIdContainKorean() {
       ...
       if (regExp.test(member_id)) {
           ...
           registerCheck(); // 한글이 포함되지 않았을 때 중복 확인 실행
       }
   }
</script>
</head>
            ...
            <div class="panel-body">
                     ...
                     <div class="input-group">
                        ...
                        <input id="member_id" name="member_id" class="form-control"
                           ...
                           <button type="button" class="btn btn-primary"
                              onclick="checkIdContainKorean()">중복확인</button>
                  ...
                  <div class="form-group">
                     ...
                     <div class="input-group">
                        <input id="password" name="password" onkeyup="passwordCheck()"
                           ...
                           placeholder="비밀번호를 입력하세요." /> <span class="input-group-addon">
                  ...
                  <div class="form-group">
                     ...
                     <div class="input-group">
                        <input id="password2" name="password2" onkeyup="passwordCheck()"
                           ...
                           class="input-group-addon"> <i id="togglePassword2"
               ...
               <div class="form-group">
                  <label for="phone">전화번호</label> <input id="phone" name="phone"
                     ...
                     maxlength="13" placeholder="전화번호를 입력하세요" value="${mem.phone }">
               </div>
               <c:if test="${empty mem}">
                  <tr class="email">
                     <td>
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input id="email" type="text" name="email"
                                 ...
                                 placeholder="이메일 주소를 입력하세요." /> <span
                                 class="input-group-btn"> <span id="emailChk"
                                 class="btn btn-primary">인증번호 보내기</span>
                              </span>
                           </div>
                           <div class="input-group" style="margin-top: 10px;">
                              ...
                              <input id="email2" type="text" name="email2" title="인증번호 입력"
                                 ...
                                 placeholder="인증번호를 입력하세요." /> <span class="input-group-btn">
                                 <span id="emailChk2" class="btn btn-primary">이메일인증</span>
                              </span>
                           </div>
                           <span class="point successEmailChk" style="margin-top: 5px;">이메일
                              입력 후 인증번호 보내기를 해주십시오.</span> <input type="hidden" id="emailDoubleChk" />
                  ...
                  <div class="input-group">
                     ...
                     <input type="text" id="postcode" class="form-control"
                        ...
                        <button class="btn btn-primary" type="button"
                           onclick="findPostcode()">주소찾기</button>
                     </span>
                  </div>
               </div>
               <div class="form-group">
                  <div class="address-field">
                     <input type="text" id="address" name="addr" class="form-control"
                        placeholder="주소">
                  </div>
                  <div class="address-field">
                  ...
                  <div class="address-field">
                     <input type="hidden" id="extraAddress" name="addr"
