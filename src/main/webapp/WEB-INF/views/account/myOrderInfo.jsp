			...
			<body>
				...
				<div class="bodyDiv">
					<div class="myPageSubDiv">
						<a href="myPageOrder?member_id=${mvo.member_id }"><img
								src="${contextPath}/resources/image/Back.png" class="backBtn"></a>
					...
					<div class="userInfoBox">
						<table class="userInfoTbl">
							<tr class="userInfoTr">
								...
								<td style="width: 110px;" class="userInfoTd"><span
										id="userInfoNameSpan">${mo.name}</span></td>
							</tr>
							<tr class="userInfoTr">
								<td style="width: 20px;" class="userInfoTd">전화번호</td>
								<td style="width: 110px;" class="userInfoTd"><span
										id="userInfoTelSpan">${mo.phone}</span></td>
							</tr>
						</table>
					</div>
					<hr class="hrSec">
					...
					<div class="userInfoBox">
						<table class="userInfoTbl" style="width: 800px;">
							...
							<tr class="userInfoTr">
								...
								<td style="width: 110px;" class="userInfoTd">
									${mo.deli_zipcode}&nbsp${mo.deli_addr}&nbsp${mo.deli_detailaddr}</td>
							</tr>
							<tr class="userInfoTr">
						...
						<table class="userInfoTbl" style="width: 770px;">
							<tr class="userInfoTr">
								...
								<td style="text-align: right">
									<fmt:formatNumber value="${mo.original_price}" pattern="#,##0" />원
								</td>
							</tr>
							<tr class="userInfoTr">
								<td>할인</td>
							...
							<tr class="userInfoTr">
								...
								<td class="lastPayTd">
									<fmt:formatNumber value="${mo.discount_price*mo.order_pcs+2500}" pattern="#,##0" />원
								</td>
							</tr>
						</table>
					</div>
